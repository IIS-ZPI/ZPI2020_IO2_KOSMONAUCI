from statisticsCalculator import coefficients, distribution_of_changes


def test_calculate_deltas_correct_output():
...
def test_calculate_deltas_incorrect_output():
    input = [{'no': '103/A/NBP/2021', 'effectiveDate': '2021-05-31', 'mid': 3.6724},
             {'no': '104/A/NBP/2021', 'effectiveDate': '2021-06-01', 'mid': 3.659},
             {'no': '105/A/NBP/2021', 'effectiveDate': '2021-06-02', 'mid': 3.6659},
             {'no': '106/A/NBP/2021', 'effectiveDate': '2021-06-04', 'mid': 3.6931},
...
def test_calculate_deltas_empty_input():
    input = []
    expected_output = []
    result = coefficients.calculate_deltas(input)
    assert result == expected_output
...
def test_get_coefficients_empty_currency():
    currency = ''
...
def test_get_distribution_of_changes_same_currencies():
    currency_1 = 'USD'
    currency_2 = 'USD'
    start_date = '01-05-2021'
    end_date = '01-06-2021'
...
def test_calculate_rates1_to_rates2_correct_output():
...
def test_calculate_rates1_to_rates2_incorrect_output():
    rate_1 = [{'no': '087/A/NBP/2021', 'effectiveDate': '2021-05-07', 'mid': 3.7861}]
    rate_2 = [{'no': '087/A/NBP/2021', 'effectiveDate': '2021-05-07', 'mid': 4.5764}]
    expected_output = [0]
    result = distribution_of_changes.calculate_rates1_to_rates2(rate_1, rate_2)
...
def test_calculate_rates1_to_rates2_empty_input():
    rate_1 = []
    rate_2 = []
    expected_output = []
    result = distribution_of_changes.calculate_rates1_to_rates2(rate_1, rate_2)
...
def test_calculate_delta_correct_output():
...
def test_calculate_delta_empty_input():
    relations = []
    expected_output = []
    result = distribution_of_changes.calculate_delta(relations)
    assert result == expected_output
...
def test_calculate_statistic_correct_output():
...
def test_calculate_statistic_incorrect_output():
    delta_tab = [0.008316627052089132, -0.000761265950074419, -0.002788739591042644, -0.0072132008479863785]
    expected_output = ([], [])
    result = distribution_of_changes.calculate_statistic(delta_tab)
    assert result != expected_output
